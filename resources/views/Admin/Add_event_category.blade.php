                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form method="POST" action="Add_event_category">
                                                        @csrf
                                 ...
                                 @error('category_name')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" placeholder="Event Description"id="exampleFormControlTextarea1" name="description" placeholder="Category Description"rows="3"></textarea>
                                                            <span style="color:red">
                                                        @error('description')
                                                        {{$message}}
                                                    @enderror</span>
